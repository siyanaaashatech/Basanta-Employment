...
<section class="single_page">
  ...
  <article class="service_card row gap-5">
    ...
    <div class="service_about col-lg-3 col-sm-12 shadow-lg bg-body-tertiary rounded order-lg-2 order-sm-3 order-xs-3"> 
    ...
    <div class="service_doc col-lg-12 col-sm-12 shadow-lg bg-body-tertiary rounded order-lg-3 order-sm-2">{!! $service->description !!}
