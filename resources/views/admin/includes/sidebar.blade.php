<nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
    ...
    <div class="d-flex align-items-center">
      <div class="toggle-icon-wrapper">
        ...
        <div class="d-flex align-items-center py-3"><img class="me-2" src="{{ asset('adminassets/assets/img/icons/spot-illustrations/falcon.png') }}" alt="" width="40"><span class="font-sans-serif">falcon</span></div>
      </a>
    </div>
          ...
          <li class="nav-item">
            ...
            <ul class="nav collapse show" id="dashboard">
              <li class="nav-item"><a class="nav-link active" href="index.html">
                  <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Sitesetting</span></div>
                </a><!-- more inner pages-->
              </li>
              <li class="nav-item"><a class="nav-link" href="dashboard/analytics.html">
                  <div class="d-flex align-items-center"><span class="nav-link-text ps-1">About us</span></div>
                </a><!-- more inner pages-->
              </li>
