            ...
            <div>
                <div class="form-group">
                    <label for="android_chrome_oneninetwo">Favicon 192*192</label><span style="color:red; font-size:large">
                        *</span>
                    <input type="file" name="android_chrome_oneninetwo" class="form-control" id="android_chrome_oneninetwo"
                        required>
                </div>
                <img id="android_chrome_oneninetwo" style="max-width: 500px; max-height:500px" />

                <div class="form-group">
                    <label for="android_chrome_fiveonetwo">Favicon 512*512</label><span style="color:red; font-size:large">
                        *</span>
                    <input type="file" name="android_chrome_fiveonetwo" class="form-control" id="android_chrome_fiveonetwo"
                        required>
                </div>
                <img id="android_chrome_fiveonetwo" style="max-width: 500px; max-height:500px" />
                ...
                <img id="favicon_ico" style="max-width: 500px; max-height:500px" />
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="site_webmanifest" class="form-control" id="pdf" placeholder="file"
                        required>
