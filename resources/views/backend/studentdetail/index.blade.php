...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ route('admin.student-details.create') }}"><button class="btn btn-primary btn-sm"><i
                        class="fa fa-plus"></i>Add
                    Student Detail</button></a>
                                ...
                                @foreach ($documents as $document)
                                    <div class="document-preview">
                                        @if (preg_match('/\.pdf$/i', $document))
                                            <iframe src="{{ asset($document) }}" style="width:100px; height:100px;"
                                                frameborder="0"></iframe>
                                        @elseif(preg_match('/\.(jpg|jpeg|png|gif)$/i', $document))
                                            <img src="{{ asset($document) }}" style="width: 50px; height: 50px;">
                                        @else
